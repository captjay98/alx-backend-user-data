#!/usr/bin/env python3
"""
Module contains functions for handling user passwords
"""
import bcrypt
...
def hash_password(password: str) -> bytes:
    """
    This function takes a str argument and encodes it
    returing a hashed password which is a byte string
    """
